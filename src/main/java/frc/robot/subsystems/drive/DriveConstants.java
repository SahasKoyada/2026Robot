...
public class DriveConstants {
    public static final double maxSpeedMetersPerSec = Units.feetToMeters(12/*15.1*/);
    ...
    public static final double turnMotorReduction = 150/7.0; //9424.0 / 203.0;
    public static final DCMotor turnGearbox = DCMotor.getNEO(1);

    // Turn encoder configuration
    public static final boolean turnEncoderInverted = true;

    public static final double oldTurnEncoderPositionFactor = 2 * Math.PI;
    public static final double oldTurnEncoderVelocityFactor = (2 * Math.PI) / 60.0;
