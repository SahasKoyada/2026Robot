...
public class VisionIOLimelight implements VisionIO {
    ...
    public void updateInputs(VisionIOInputs inputs) {
        ...
        inputs.latestTargetObservation = new TargetObservation(
                Rotation2d.fromDegrees(txSubscriber.get()), Rotation2d.fromDegrees(tySubscriber.get()), NetworkTableInstance.getDefault().getTable("limelight-tag").getEntry("tid").getDouble(0));
